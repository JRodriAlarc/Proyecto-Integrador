<?php
    ...
    include_once "img_select_file.php";

    $ArchivoPermitido = array("image/png", "image/jpg", "image/gif", "image/raw", "image/jpeg");
    ...
    if(in_array($TipoArchivo, $ArchivoPermitido) == false){
        ...
        ?>
            ...
            <div class="d-grid col-6 col-md-5 col-lg-4 mx-auto mb-5">
                ...
                <button class="btn btn-danger fw-bolder" type="submit" name="recargar-sitio" id="recargar-sitio">¡Selecciona Otro Archivo!</button>

                <script src="../js/img_restart.js"></script>

            </div>


            <div class="alert alert-danger d-flex align-items-center" role="alert">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-sign-stop-fill me-2" viewBox="0 0 16 16">
